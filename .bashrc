...
## Nick's additions from previous Linuxes
alias rm='rm -i'
...
export PATH=/home/nick/bin:$PATH 
export PATH=/usr/local/texlive/2019/bin/i386-linux:$PATH
...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/home/nick/miniconda3/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
